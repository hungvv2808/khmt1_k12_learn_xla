...
if __name__ == "__main__":
    """
    - Có npoints điểm lân cận và bán kính radius do người dùng đặc tả
        => ta tính được mỗi cung tròn thành phần có góc bao nhiêu (360 độ / npoints)
        => ước tính được tọa độ x, y của mỗi pixel lân cận @ delta_x, delta_y.
        Lưu ý rằng lúc tính delta_y ta phải có dấu trừ (-) ở đặc trước vì vì gốc tọa độ của ảnh nằm ở phía trên bên trái (top left),
        do đó trục y nó bị ngược so với gốc tọa độ trong toán học (nằm ở phía dưới bên trái - bottom left) mà ta thường tính sin / cos.
    - Neighbor_positions.reverse(): ta duyệt vòng tròn (các pixel lân cận) theo thứ tự điểm đầu tiên ở 0 độ,
        các điểm tiếp theo ngược kim đồng hồ. Ta muốn điểm lân cận xét đầu tiên sẽ nằm cuối chuỗi nhị phân (00000001) do đó ta đảo list lại.
